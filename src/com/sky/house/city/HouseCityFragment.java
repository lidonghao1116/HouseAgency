...
//	        
////	        jsonA.addAll(BrandUtils.getLocalContactList(ContactActivity.this, false, true));
//	        jsonArray = BrandUtils.getBrandList(jsonArray, false, true);
//	        
//	        mLetters =
//	                new String[] {
	...
	private class LetterListAdapter extends ArrayAdapter<String> {
     ...
     public View getView(int position, View convertView, ViewGroup parent) {
         ...
         if (convertView == null) {
             ...
             letterView.setLayoutParams(new ListView.LayoutParams(LayoutParams.MATCH_PARENT,
             		mLvCity.getMeasuredHeight() / 26));
//             letterView.setTextSize(mContactListView.getMeasuredHeight() / 26 * 0.6f);
